...
@section('title', 'Tambah Kriteria - SPK MOORA')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Tambah Kriteria Evaluasi</h1>
        ...
        <form action="{{ route('admin.kriteria.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="kode_kriteria" class="form-control" value="{{ old('kode_kriteria') }}" required>
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <select name="jenis" class="form-control" required>
                        <option value="Benefit" {{ old('jenis') == 'Benefit' ? 'selected' : '' }}>Benefit (+ Menguntungkan)</option>
                        <option value="Cost" {{ old('jenis') == 'Cost' ? 'selected' : '' }}>Cost (- Merugikan)</option>
                    </select>
                </div>
                <div class="col-md-6 form-group">
                    <label>Nilai Bobot (Skala 1-100, cth: 15) <span class="text-danger">*</span></label>
                    <input type="number" step="0.01" name="bobot" class="form-control @error('bobot') is-invalid @enderror" value="{{ old('bobot') }}" required>
                    @error('bobot')
