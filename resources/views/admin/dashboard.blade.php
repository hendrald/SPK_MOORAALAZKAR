...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('admin.moora.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
            class="fas fa-trophy fa-sm text-white-50"></i> Lihat Hasil MOORA</a>
</div>
    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Top 5 Guru Terbaik (Periode: {{ $latestPeriod ?? 'Belum Ada' }})</h6>
            </div>
            <div class="card-body">
                @if(empty($top5))
