...
@section('title', 'Edit Guru - SPK MOORA')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Edit Data Guru Baru</h1>

<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Form Update Profil Guru</h6>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form action="{{ route('admin.guru.update', $guru->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    <label>Password Baru <small>(Biarkan kosong jika tidak ingin ganti sandi)</small></label>
                ...
                <div class="col-md-6 form-group">
                    <label>Foto Profil (Opsional, max 2MB)</label><br>
                    @if($guru->foto)
                        <img src="{{ Storage::url($guru->foto) }}" alt="Foto Lama" class="img-thumbnail mb-2" style="max-height: 100px;">
                    @else
                        <span class="badge badge-secondary mb-2">Belum ada foto</span>
                    @endif
