...
<div style="margin-bottom: 2rem; max-width: 800px; margin-left: auto; margin-right: auto; text-align: center;">
    <h1 style="font-size: 2.2rem; font-weight: 900; margin-bottom: 0.5rem; background: linear-gradient(135deg, var(--primary-color) 0%, var(--accent-color) 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Halo, {{ explode(' ', $guru->nama_lengkap ?? Auth::user()->name)[0] }}!</h1>
...
<div style="display: flex; justify-content: center; align-items: center;">
    ...
    <div class="glass-panel" style="padding: 3rem; text-align: center; width: 100%; max-width: 450px;">
        <div style="position: relative; width: 140px; height: 140px; margin: 0 auto 1.5rem auto;">
            @if($guru && $guru->foto)
                <img src="{{ asset('storage/' . $guru->foto) }}" alt="Profile" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%; border: 4px solid var(--accent-color); box-shadow: 0 8px 25px rgba(82, 183, 136, 0.3);">
            @else
                <img src="{{ asset('img/logo.png') }}" alt="Default Profile" style="width: 100%; height: 100%; object-fit: contain; border-radius: 50%; border: 4px solid var(--accent-color); box-shadow: 0 8px 25px rgba(82, 183, 136, 0.3); background: white;">
            @endif
        </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 12px; text-align: left; background: #f9fafb; padding: 1.5rem; border-radius: 1.5rem; border: 2px dashed #e5e7eb;">
            <div style="display: flex; align-items: center; gap: 12px;">
                <div style="background: rgba(241, 127, 114, 0.15); width: 38px; height: 38px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--secondary-color);">
            ...
            <div style="display: flex; align-items: center; gap: 12px; margin-top: 5px;">
                <div style="background: rgba(82, 183, 136, 0.15); width: 38px; height: 38px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--accent-color);">
